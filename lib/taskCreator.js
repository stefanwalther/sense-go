	...
	var _gulpConfig = function () {
		...
		gulp.task( 'init', function ( done ) {
			return senseLoc.getLocalExtensionPath( function ( err, data ) {
				...
				//gutil.log( 'Result', chalk.cyan( '\'init\'' ), 'localExtensionDir: ', chalk.blue( config.localExtensionDir ) );
				//gutil.log( 'Result', chalk.cyan( '\'init\'' ), 'localExtensionPath: ', chalk.blue( config.localExtensionPath ) );
				done( err );
			} );
		} );
	};
